...
import {
  Admin,
  AdminDocument,
  trimAdminCollectionDocument,
  trimAdminItemDocument,
...
export class AdminRepository {
  ...
  async getAdminItem(
    ...
    try {
      ...
      return trimAdminItemDocument(admin);
    } catch (e) {
      return new InternalServerErrorException(e);
    }
  }
  ...
  async getAdminCollection(
    ...
    try {
      ...
      return trimAdminCollectionDocument(user);
    } catch (e) {
      return new InternalServerErrorException(e);
    }
  }
  ...
  > {
    try {
      return (await this.adminModel.find()).map((e) =>
        trimAdminItemDocument(e),
      );
    } catch (e) {
      return new InternalServerErrorException(e);
    }
